...
let activePlayer = 'X';
// This array stores an arary of moves. We use this to determine win conditions.
let selectedSquares = [];
...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        // This condition checks to see if it is the commputers turn.
        if (activePlayer === 'O') {
    ...
    // This functino parses the selectedSquares array to search for win conditions.
    // drawLine() function is called to draw a line on thet screen if the ondition is met.
    function checkWinConditions() {
        ...
        function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
            ...
            function animateLineDrawing() {
                ...
                if (x1 <= x2 && y1 <= y2) {
                    // This condition adds 10 to the previous to the previous end x endpoint.
                    if (x < x2) { x += 10; }
                ...
                function resetGame() {
                    // This for loop tierates through each HTML square element.
                    for (let i= 0; i < 9; i++) {
