...
// This seciont handles decimal points.
...
function Handle_Operator(Next_Operator) {
    ...
    // then updates the operator and and exits from the function.
    ...
    if (First_Operand == null) {
        ...
        // in the Perform_Calculation obejct and the function that matches the
        // operator is executed.
        let result = Perform_Calculation[operator](Value_Now, Value_of_Input);
        // Here we add a fixed aount of numbers after the decimal.
